...
public class ItemCorteAdapter extends RecyclerView.Adapter<ItemCorteAdapter.ViewHolderFacturas> {
    private ArrayList<String> itemFacturas;

    public ItemCorteAdapter(ArrayList<String> itemFacturas) {
    ...
    public ViewHolderFacturas onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemcortexdeuda,null,false);
    ...
    public static class ViewHolderFacturas extends RecyclerView.ViewHolder {
        ...
        public ViewHolderFacturas(@NonNull View itemView) {
            super(itemView);
            mensaje = itemView.findViewById(R.id.mensajecorte);
